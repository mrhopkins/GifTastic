...
$(document).ready(function () {
	...
	var movies = ["The Excorcist", "Halloween", "The Shining", "Psycho", "A Nightmare on Elm Street", "The Texas Chain Saw Massacre", "The Evil Dead", "Night of the Living Dead", "Friday the 13th", "Scream", "The Ring", "Poltergeist", "The Descent", "The Omen", "Birdemic", "Re-Animator", "Slumber Party Massacre 2", "Excision", "Silent Night Deadly Night", "Videodrome", "Final Destination"]
	GIFArea = " "
	...
	$(document).on('click', 'button', function () {
		...
		var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + b + "&api_key=Cm28gxtrNhDU8x05Sa0h1kHt8UXNPYf0&limit=12";  //query api url and public key
